...
// ValidateControllerServiceRequest validates the k8scontroller
// plugin capabilities.
...
// AddControllerServiceCapabilities stores the k8scontroller capabilities
// in driver object.
func (d *CSIDriver) AddControllerServiceCapabilities(cl []csi.ControllerServiceCapability_RPC_Type) {
	var csc []*csi.ControllerServiceCapability

	for _, c := range cl {
		util.DefaultLog("Enabling k8scontroller service capability: %v", c.String())
